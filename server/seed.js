    ...
    const jobs = await Job.create([
      {
        ...
        description: 'Work on large-scale search and ranking infrastructure.',
        requirements: ['Algorithms and data structures', 'Experience in Java/C++/Go/Python'],
      ...
      },
      {
        ...
        description: 'Build robust payment APIs under mentorship.',
        requirements: ['Pursuing CS degree', 'Proficiency with Node.js or Go'],
        salary: '$45 / hour',
      ...
      },
      {
        ...
        description: 'Build delightful web interfaces and dashboards.',
        requirements: ['React', 'CSS/Tailwind', 'Accessibility'],
      ...
      },
      {
        ...
        description: 'Work on production ML pipelines and models.',
        requirements: ['Python', 'Pandas/NumPy', 'Exposure to ML frameworks'],
        salary: '$35 / hour',
      ...
      },
      {
        ...
        requirements: ['Docker', 'Kubernetes', 'AWS/GCP experience'],
        salary: '$110,000 / year',
        location: 'Remote',
        type: 'full-time',
      ...
      },
      {
        ...
        requirements: ['Flutter or React Native', 'UI/UX sensibilities'],
        salary: '$90,000 / year',
        location: 'Austin, TX',
        type: 'full-time',
      ...
      },
      {
        ...
        requirements: ['SQL', 'Tableau/PowerBI', 'Analytical mindset'],
        salary: '$75,000 / year',
        location: 'Pune, India',
        type: 'full-time',
      ...
      },
      {
        ...
        description: 'Assist in research projects on ML and optimization.',
        requirements: ['Strong math background', 'Python experience'],
        salary: '$40 / hour',
      ...
      },
      {
        ...
        description: 'Work across backend and frontend to ship ecommerce features.',
        requirements: ['Node.js', 'React', 'Databases'],
        salary: '$105,000 / year',
        location: 'Bengaluru, India',
        type: 'full-time',
      ...
      },
      {
        ...
        description: 'Monitor security posture and respond to incidents.',
        requirements: ['Security principles', 'Familiarity with Linux systems'],
        salary: '$95,000 / year',
        location: 'Remote',
        type: 'full-time',
